...
{ 
	    ...
	    do {
			...
			for(i = 0; i < NC ; i++){
				int indice=0;
				int iteraciones = (NC/BLOQUE);
				int resto = (NC%BLOQUE);
				while(iteraciones-- > 0){
					v_resul[i] += v_datos[indice+10+i] * v_coef[indice+10 -1];
					v_resul[i] += v_datos[indice+9+i] * v_coef[indice+9 -1];
					v_resul[i] += v_datos[indice+8+i] * v_coef[indice+8 -1];
					v_resul[i] += v_datos[indice+7+i] * v_coef[indice+7 -1];
					v_resul[i] += v_datos[indice+6+i] * v_coef[indice+6 -1];
					v_resul[i] += v_datos[indice+5+i] * v_coef[indice+5 -1];
					v_resul[i] += v_datos[indice+4+i] * v_coef[indice+4 -1];
					v_resul[i] += v_datos[indice+3+i] * v_coef[indice+3 -1];
					v_resul[i] += v_datos[indice+2+i] * v_coef[indice+2 -1];
					v_resul[i] += v_datos[indice+1+i] * v_coef[indice+1 -1];
					indice +=BLOQUE;
				}
				switch(resto) {
					case 9: v_resul[i] += v_datos[indice+9+i] * v_coef[indice+9 -1];
					case 8: v_resul[i] += v_datos[indice+8+i] * v_coef[indice+8 -1];
					case 7: v_resul[i] += v_datos[indice+7+i] * v_coef[indice+7 -1];
					case 6: v_resul[i] += v_datos[indice+6+i] * v_coef[indice+6 -1];
					case 5: v_resul[i] += v_datos[indice+5+i] * v_coef[indice+5 -1];
					case 4: v_resul[i] += v_datos[indice+4+i] * v_coef[indice+4 -1];
					case 3: v_resul[i] += v_datos[indice+3+i] * v_coef[indice+3 -1];
					case 2: v_resul[i] += v_datos[indice+2+i] * v_coef[indice+2 -1];
					case 1: v_resul[i] += v_datos[indice+1+i] * v_coef[indice+1 -1];
					case 0: ;
				}
			}
